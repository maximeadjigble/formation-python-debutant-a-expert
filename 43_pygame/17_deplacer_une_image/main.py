...
acteur_rect = acteur.get_rect(midbottom = (LARGEUR/2, HAUTEUR))
acteur_rect = acteur_rect.inflate((-20,-5))
#Pièces
piece = pygame.image.load(os.path.join('assets', 'piece_1.png')).convert_alpha()
piece_rects = []
for i in range(5):
    piece_rects.append(piece.get_rect(center = (200*i, HAUTEUR - 150)))
